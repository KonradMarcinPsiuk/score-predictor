...
1.  A Dockerfile.
2.	A working directory called /opt/flask_scorepredictor
...
8.	Student_Performance.csv which is the dataset that is required to train the linear regression model.
